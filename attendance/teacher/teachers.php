...
if ($tcr_query->num_rows > 0) {
    $i = 0; 
    //$tcr_query->fetch_assoc() renvoie une ligne de résultat sous forme de tableau associatif, où les clés sont les noms des colonnes de la table et les valeurs sont les données correspondantes.
